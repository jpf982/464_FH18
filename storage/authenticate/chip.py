...
class Chip:
    def __init__(self, _name, _identity, _freqvals, _Tvals, _accessList):
        self.name = _name
        self.identity = _identity
        self.Tvals = deepcopy(_Tvals)
        self.accessList = deepcopy(_accessList)
        self.freqvals = deepcopy(_freqvals)
        self.npoints = _testFreqvals.size
        self.maxf = np.amax(_testFreqvals)
        self.minf = np.amin(_testFreqvals)
